      ...
      <section className="relative min-h-[75vh] flex items-center overflow-hidden bg-gray-50">
        ...
        <div className="relative max-w-5xl mx-auto px-6 text-center text-white">
          <h1 className="text-4xl md:text-6xl font-bold leading-tight">
            <span className="block animate-fade-up">อยู่ในกรุงเทพมหานคร</span>
          ...
          {!loading && dataPlaces.length > 0 ? (
            ...
            <div className="text-center py-20">
              ...
              <p className="mt-2 text-slate-500">
                ลองค้นหาด้วยชื่อสถานที่ หรือชื่อสถานีขนส่งมวลชนใกล้เคียง
              </p>

              <p className="mt-4 text-sm text-slate-400">
                ตัวอย่าง: “ห้วยขวาง”, “BTS อโศก”, “สำนักงานเขตบางนา”
              </p>
